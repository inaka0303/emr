...
func Run(db *sql.DB) error {
	...
	interviewNotes := []struct {
		...
		// 山田太郎 - 頭痛で来院（デモのメインシナリオ）
		{4, "3日前から頭痛が続いています。ズキズキする痛みで午後になると悪化します。市販の鎮痛剤（イブプロフェン）を飲みましたがあまり効きません。吐き気はありませんが、光がまぶしく感じることがあります。仕事はデスクワークで最近残業が多く、睡眠不足気味です。高血圧と糖尿病で通院中です。父が糖尿病、母が高血圧です。タバコは1日20本吸っています。"},
		// 佐藤美咲 - 糖尿病フォロー（デモの第2シナリオ）
		{7, "糖尿病の定期受診です。最近仕事が忙しく、外食が増えてしまいました。体重が少し増えた気がします。ウォーキングは週2回続けています。週末にビールを1本飲む程度です。父が糖尿病です。足のしびれや目の見えにくさはありません。口の渇きが少し気になります。"},
		// 既存患者の問診
		{8, "2週間前から時々胸が苦しくなります。特に階段を上るときに感じます。休むと5分くらいで楽になります。以前から血圧が高いと言われています。父が65歳で心筋梗塞を起こしています。タバコは10年前にやめました。お酒は日本酒を毎日2合くらい飲みます。"},
		{19, "花粉症がひどくなりました。くしゃみ、鼻水、目のかゆみがあります。市販の薬では効果が不十分です。夜も鼻づまりで眠れません。"},
		{27, "2日前から熱が38度台あります。咳と喉の痛みがあります。周囲にインフルエンザの人はいません。食欲はやや落ちています。"},
	}
